...
% save('ProbSucc_vs_SupportSize_study_random.mat')
figure
% support size=1
sbl_supp_succ_rate=permute(sum(seqsbl_suppdist==0,1),[2 3 1]);%seqsbl_Cinv_suppdist
sbl_supp_succ_prob=sbl_supp_succ_rate/ITER;%meas. size X supp. size
plot(suppsizelist,sbl_supp_succ_prob(:,1), '-sb', 'LineWidth', 2, 'MarkerSize', 8)
hold on
omp_supp_succ_rate=permute(sum(omp_suppdist==0,1),[2 3 1]);%seqsbl_Cinv_suppdist
omp_supp_succ_prob=omp_supp_succ_rate/ITER;%meas. size X supp. size
plot(suppsizelist,omp_supp_succ_prob(:,1), '-or', 'LineWidth', 2, 'MarkerSize', 4)

% sp_supp_succ_rate=permute(sum(sp_suppdist==0,1),[2 3 1]);%seqsbl_Cinv_suppdist
% sp_supp_succ_prob=sp_supp_succ_rate/ITER;%meas. size X supp. size
% plot(suppsizelist,sp_supp_succ_prob(:,1), '-*g', 'LineWidth', 2, 'MarkerSize', 15)

% L1_supp_succ_rate=permute(sum(L1_suppdist==0,1),[2 3 1]);%seqsbl_Cinv_suppdist
% L1_supp_succ_prob=L1_supp_succ_rate/ITER;%meas. size X supp. size
% plot(suppsizelist,L1_supp_succ_prob(:,1), '-pc', 'LineWidth', 2, 'MarkerSize', 15)
grid on
xlabel('Support size')
ylabel('Success probability')
% legend('LWS-SBL', 'OMP', 'Subspace Pursuit', 'L1', 'Location', 'SouthWest')
legend('LWS-SBL', 'OMP', 'Location', 'SouthWest')
set(gca, 'FontWeight', 'bold', 'FontSize', 12)
xticks(0:5:30)
yticks(0:0.1:1)
% Measurement size=m(miter)
miter=2; disp(['Measurement size=' num2str(m(miter))])
plot(suppsizelist,sbl_supp_succ_prob(:,miter), '-sb', 'LineWidth', 2, 'MarkerSize', 8)
plot(suppsizelist,omp_supp_succ_prob(:,miter), '-or', 'LineWidth', 2, 'MarkerSize', 4)
% plot(suppsizelist,sp_supp_succ_prob(:,miter), '-*g', 'LineWidth', 2, 'MarkerSize', 8)
% plot(suppsizelist,L1_supp_succ_prob(:,miter), '-pc', 'LineWidth', 2, 'MarkerSize', 8)
miter=3; disp(['Measurement size=' num2str(m(miter))])
plot(suppsizelist,sbl_supp_succ_prob(:,miter), '-sb', 'LineWidth', 2, 'MarkerSize', 8)
plot(suppsizelist,omp_supp_succ_prob(:,miter), '-or', 'LineWidth', 2, 'MarkerSize', 4)
% plot(suppsizelist,sp_supp_succ_prob(:,miter), '-*g', 'LineWidth', 2, 'MarkerSize', 8)
% plot(suppsizelist,L1_supp_succ_prob(:,miter), '-pc', 'LineWidth', 2, 'MarkerSize', 8)
% miter=5; disp(['Support size=' num2str(m(miter))])
% plot(suppsizelist([1 5:end]),sbl_supp_succ_prob([1 5:end],miter), '-sb', 'LineWidth', 2, 'MarkerSize', 15)
% plot(suppsizelist([1 5:end]),omp_supp_succ_prob([1 5:end],miter), '-or', 'LineWidth', 2, 'MarkerSize', 8)
% legend('LWS-SBL', 'OMP', 'Subspace Pursuit', 'L1','Location', 'SouthWest')
legend('LWS-SBL', 'OMP','Location', 'SouthWest')
%%
