...
% sp_l2error = zeros(ITER, suppsizemax,length(m)); sp_suppdist = zeros(ITER, suppsizemax,length(m));
% sp_orig_l2error = zeros(ITER, suppsizemax,length(m)); sp_orig_suppdist = zeros(ITER, suppsizemax,length(m));
% lsomp_l2error = zeros(ITER, suppsizemax,length(m)); lsomp_suppdist = zeros(ITER, suppsizemax,length(m));
seqsbl_l2error = zeros(ITER, suppsizemax,length(m)); seqsbl_suppdist = zeros(ITER, suppsizemax,length(m)); seqsbl_timecomp = zeros(ITER, suppsizemax,length(m));
seqsbl_Cinv_l2error = zeros(ITER, suppsizemax,length(m)); seqsbl_Cinv_suppdist = zeros(ITER, suppsizemax,length(m)); seqsbl_Cinv_timecomp = zeros(ITER, suppsizemax,length(m));
seqsbl_nvarNotgivenwvarby10_l2error = zeros(ITER, suppsizemax,length(m)); seqsbl_nvarNotgivenwvarby10_suppdist = zeros(ITER, suppsizemax,length(m)); seqsbl_nvarNotgivenwvarby10_timecomp = zeros(ITER, suppsizemax,length(m));
seqsbl_nvarNotgivenwvar10_l2error = zeros(ITER, suppsizemax,length(m)); seqsbl_nvarNotgivenwvar10_suppdist = zeros(ITER, suppsizemax,length(m)); seqsbl_nvarNotgivenwvar10_timecomp = zeros(ITER, suppsizemax,length(m));
seqsbl_targetsj_l2error = zeros(ITER, suppsizemax,length(m)); seqsbl_targetsj_suppdist = zeros(ITER, suppsizemax,length(m)); seqsbl_targetsj_timecomp = zeros(ITER, suppsizemax,length(m));
seqsbl_ximprov_l2error = zeros(ITER, suppsizemax,length(m)); seqsbl_ximprov_suppdist = zeros(ITER, suppsizemax,length(m)); seqsbl_ximprov_timecomp = zeros(ITER, suppsizemax,length(m));
redcompomp_l2error = zeros(ITER, suppsizemax,length(m)); redcompomp_suppdist = zeros(ITER, suppsizemax,length(m)); redcompomp_timecomp = zeros(ITER, suppsizemax,length(m));
omp_l2error = zeros(ITER, suppsizemax,length(m)); omp_suppdist = zeros(ITER, suppsizemax,length(m)); omp_timecomp = zeros(ITER, suppsizemax,length(m));
% mp_l2error = zeros(ITER, suppsizemax,length(m)); mp_suppdist = zeros(ITER, suppsizemax,length(m));
% weakmp_l2error = zeros(ITER, suppsizemax,length(m)); weakmp_suppdist = zeros(ITER, suppsizemax,length(m));
% thresh_l2error = zeros(ITER, suppsizemax,length(m)); thresh_suppdist = zeros(ITER, suppsizemax,length(m));
% L1_l2error = zeros(ITER, suppsizemax,length(m)); L1_suppdist = zeros(ITER, suppsizemax,length(m));
% RL1_l2error = zeros(ITER, suppsizemax,length(m)); RL1_suppdist = zeros(ITER, suppsizemax,length(m));
% reg_IRLS_l2error = zeros(ITER, suppsizemax,length(m)); reg_IRLS_suppdist = zeros(ITER, suppsizemax,length(m));
% SBL_l2error = zeros(ITER, suppsizemax,length(m)); SBL_suppdist = zeros(ITER, suppsizemax,length(m));
...
figure
sbl_supp_succ_rate=permute(sum(seqsbl_suppdist==0,1),[3 2 1]);%seqsbl_nvarNotgivenwvar10_suppdist
sbl_min_m_identify=sbl_supp_succ_rate>=0.9*ITER;
tmp=sbl_min_m_identify.*repmat(m',1,suppsizemax);
tmp(tmp==0)=Inf;
hold on
plot(1:suppsizemax, min(tmp), '-sb', 'LineWidth', 2, 'MarkerSize', 15)
xlabel('Support size')
...
yticks(40:20:300)
axis([0 25 40 300])
omp_supp_succ_rate=permute(sum(omp_suppdist==0,1),[3 2 1]);
omp_min_m_identify=omp_supp_succ_rate>=0.9*ITER;
tmp=omp_min_m_identify.*repmat(m',1,suppsizemax);
tmp(tmp==0)=Inf;
hold on
plot(1:suppsizemax, min(tmp), '-or', 'LineWidth', 2, 'MarkerSize', 8)
legend('LWS-SBL', 'OMP','Location', 'NorthWest')
